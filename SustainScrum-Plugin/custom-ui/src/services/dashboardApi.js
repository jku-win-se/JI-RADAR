 ...
 */
export const getDashboardData = async (projectKey, sprintId = null, sprintName = null, trendsDays = 0) => {
    try {
        const result = await invoke('getDashboardData', { projectKey, sprintId, sprintName, trendsDays });
        return result;
    } catch (error) {
